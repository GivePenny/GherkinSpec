...
namespace GivePenny.GherkinCore.TestAdapter.UnitTests
{
    ...
    public class MethodMapperShould
    {
        ...
        public void ThrowExceptionIfMethodRequiresMoreArgumentsThanTheStepAttributeProvides()
        {
            ...
            Assert.AreEqual(
                @"The step ""Given not enough captures to satisfy method arguments"" matches the method ""GivenNotEnoughCaptures"" on class ""GivePenny.GherkinCore.TestAdapter.UnitTests.Samples.StepBindingStaticSamples"". That method expects 2 parameters but the step only provides 1.",
                exception.Message);
        }
    }
}
